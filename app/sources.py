    ...
    try:
        ...
        return TimeObservation(
            ...
            uncertainty_ms=float(
                data.get("uncertainty_ms", 1000.0)
            ),
            valid=bool(data.get("valid", False)),
            observed_monotonic_ns=finished_monotonic,
            observed_wall_utc=finished_wall,
            details={
                **data.get("details", {}),
                "endpoint": url,
                "request_started_wall_utc": (
                    started_wall.isoformat()
                ),
                "request_finished_wall_utc": (
                    finished_wall.isoformat()
                ),
